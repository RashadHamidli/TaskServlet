...
public class AddEmployeeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            Template template = cfg.getTemplate("addEmployee.ftl");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (department == null) {
                throw new ServletException("Department not found");
            }

            EmployeeRequestDTO employeeRequestDTO = new EmployeeRequestDTO();
            employeeRequestDTO.setEmployeeName(employeeName);
            employeeRequestDTO.setDepartmentId(department.getDepartmentId());

            IEmployeeDAO employeeDAO = new EmployeeDAO();
            employeeDAO.addEmployee(employeeRequestDTO);
